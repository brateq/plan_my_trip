...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { latitude: @attraction.latitude, link: @attraction.link, longitude: @attraction.longitude, name: @attraction.name, type: @attraction.type }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { latitude: @attraction.latitude, link: @attraction.link, longitude: @attraction.longitude, name: @attraction.name, type: @attraction.type }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
